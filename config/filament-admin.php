...
return [
    ...
    */
    ...
    'pages' => [
        ...
        'path' => app_path('FilamentAdmin/Pages'),
        'register' => [
    ...
    */
    ...
    'resources' => [
        ...
        'path' => app_path('FilamentAdmin/Resources'),
        'register' => [],
    ],
    ...
    */
    ...
    'widgets' => [
        'namespace' => 'App\\FilamentAdmin\\Widgets',
        'path' => app_path('FilamentAdmin/Widgets'),
        'register' => [
    ...
    */
    ...
    'livewire' => [
        'namespace' => 'App\\FilamentAdmin',
        'path' => app_path('FilamentAdmin'),
    ],
